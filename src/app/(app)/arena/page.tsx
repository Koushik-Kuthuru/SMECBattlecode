...
const ContestCard = ({ title, description, participants, time, isLive }: { title: string, description: string, participants: string, time: string, isLive?: boolean }) => (
  <Card className="hover:shadow-lg transition-shadow">
    ...
    <CardFooter>
      <Button className="w-full" variant={isLive ? 'default' : 'secondary'}>{isLive ? 'Join Now' : 'View Contest'}</Button>
    </CardFooter>
  </Card>
);
  ...
  return (
    <div className="container mx-auto py-8">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold tracking-tight">Challenge Arena</h1>
      ...
      <div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
            ...
            <ContestCard title="Python Code-Off" description="Python-exclusive problems for all skill levels." participants="120+" time="2 Hours" />
            <ContestCard title="Logic Legion" description="Put your logical thinking to the test." participants="200+" time="2.5 Hours" />
        </div>
      </div>
    </div>
  );
